...
<div class="form-group">
	<div class="col-md-12">
		...
		<input name="input_name" type="text" class="form-control" value="">
    </div>       
</div> 
...
<div class="form-group">
	<div class="col-md-12">
		<label class="control-label">input_title</label>
		<textarea name="input_name" id="editor1" rows="10" cols="80"></textarea>
    </div>       
</div> 
...
<div class="form-group">
	<div class="col-md-12">
		<p style="margin-top: 20px;" class="text-right">
          <button type="submit" class="btn btn-lg btn-space btn-primary">Ekle</button>
